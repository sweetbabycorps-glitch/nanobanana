                ...
                <div className="p-4 bg-gradient-to-br from-purple-900/30 to-indigo-900/30 rounded-lg border border-purple-500/30">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="text-sm font-semibold text-purple-300">
                      Научитесь создавать ИИ-приложения
                    </h4>
                  </div>
                  <p className="text-sm text-gray-300 mb-4">
                    Научитесь создавать приложения, подобные этому, освойте автоматизацию ИИ, создавайте интеллектуальных агентов и передовые решения для бизнеса.
                  </p>
                  <a
                  ...
                  >
                    Присоединиться к AI Accelerator
                ...
                <div className="p-4 bg-gradient-to-br from-yellow-900/30 to-orange-900/30 rounded-lg border border-yellow-500/30">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="text-sm font-semibold text-yellow-300">
                      Получите копию этого приложения
                    </h4>
                  </div>
                  <p className="text-sm text-gray-300 mb-4">
                    Получите копию этого приложения, присоединившись к сообществу Vibe Coding is Life. Живые сессии по разработке, проекты, ресурсы и многое другое.
                  </p>
                  <a
                  ...
                  >
                    Вступить в сообщество Vibe Coding
                    <ExternalLink className="h-4 w-4 ml-1" />
                  </a>
                </div>
              </div>
