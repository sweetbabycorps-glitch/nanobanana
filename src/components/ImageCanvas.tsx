        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            {selectedTool === 'mask' && (
              <>
                <div className="flex items-center space-x-2 mr-2">
                  <span className="text-xs text-gray-400">Кисть:</span>
                  <input
                    type="range"
                    min="5"
                    max="50"
            ...
            >
              ...
              <span className="hidden sm:inline ml-2">Маски</span>
            </Button>
        ...
        <div className="flex items-center justify-between text-xs text-gray-500">
          <div className="flex items-center space-x-4">
            {brushStrokes.length > 0 && (
              <span className="text-yellow-400">Мазков кисти: {brushStrokes.length}</span>
            )}
          </div>
          
          <div className="flex items-center space-x-2">
            <span className="text-yellow-400 hidden md:inline">⚡</span>
            <span className="hidden md:inline">На базе Gemini 3 PRO</span>
          </div>
        </div>
      </div>
    </div>
